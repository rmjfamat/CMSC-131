...
CLEAR_SCREEN0 PROC NEAR
  MOV AX, 0600H   ;full screen
  MOV BH, 09H    ;black background (0), blue foreground (1)
  MOV CX, 0000H   ;upper left row:column (0:0)
...
CLEAR_SCREEN4 PROC NEAR
  MOV AX, 0600H   ;full screen
  MOV BH, 84H    ;white background (7), blue foreground (1)
...
EXTRACT PROC NEAR
  ...
  MOV CX, 7                                                           ;same will happen to level 2(same with level 1) except the value of cx is 7, meanind, the word for level 2 has 2 letters
...
;--------------------------------------------------------------------------------LEVEL3
    ...
    MOV CX, 9                                                         ;same will happen to level 3(same with level 1) except the value of cx is 9, meanind, the word for level 2 has 2 letters
    MOV BX, 7                                                         ;7 words for level2
